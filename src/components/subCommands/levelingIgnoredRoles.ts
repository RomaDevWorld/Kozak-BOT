...
const cmd = new SlashCommandSubcommandBuilder()
  ...
  .setDescriptionLocalizations({ uk: 'Вкажіть до 10 ролей, власникам яких не буде видаватись досвід' })
...
const LevelingIgnoredRolesSubcommand: SubCommand = {
  data: cmd,
  execute: async (interaction) => {
    ...
    await Modules.findOneAndUpdate({ guildId: interaction.guildId }, { 'leveling.ignoredRoles': roles }, { upsert: true })
...
export default LevelingIgnoredRolesSubcommand
